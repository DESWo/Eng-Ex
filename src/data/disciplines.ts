    ...
    challenges: [
      ...
      },
      {
        ...
        why: [
          ...
          {
            icon: ShieldCheck,
            title: 'A stiffer building is a rougher ride',
            body: 'Bracing every bay stops the frame bending, but the shaking then goes straight through it to whatever is inside. A hospital scanner can be broken by a building that never came close to falling down.',
          },
          {
            icon: Anchor,
            title: 'Bearings buy softness, and need room',
            body: 'Rubber bearings let the ground slide underneath, which slows the whole building down and cuts the jolt. The price is movement: the building has to have somewhere to go, and the gap around it has to be wide enough.',
          },
        ],
      },
    ],
